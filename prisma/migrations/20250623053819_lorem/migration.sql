...
ALTER TABLE `User` ADD COLUMN `phone` VARCHAR(191) NULL,
    ADD COLUMN `role` ENUM('benfek', 'principal', 'pharmacy', 'researcher') NOT NULL DEFAULT 'benfek';
...
-- AddForeignKey
ALTER TABLE `CartItem` ADD CONSTRAINT `CartItem_supplementId_fkey` FOREIGN KEY (`supplementId`) REFERENCES `Supplement`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `OrderItem` ADD CONSTRAINT `OrderItem_supplementId_fkey` FOREIGN KEY (`supplementId`) REFERENCES `Supplement`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
