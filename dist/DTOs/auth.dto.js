...
exports.RegisterBenfekSchema = exports.RefreshTokenSchema = exports.LoginUserSchema = exports.RegisterUserSchema = void 0;
...
exports.RegisterBenfekSchema = zod_1.z.object({
    username: zod_1.z.string().min(2, 'Username must be at least 2 characters').transform(val => val.trim()),
    email: zod_1.z.string().email('Invalid email format').transform(val => val.trim()),
    password: zod_1.z
        .string()
        .transform(val => val.trim())
