...
const principal_repository_1 = require("../repositories/principal.repository");
...
// Bind repositories
container.bind(nutrienttype_repository_1.NutrientTypeRepository).toSelf();
...
container.bind(paystack_repository_1.PaystackRepository).toSelf();
container.bind(order_repository_1.OrderRepository).toSelf();
container.bind(quizcode_repository_1.QuizCodeRepository).toSelf();
container.bind(principal_repository_1.PrincipalRepository).toSelf();
// Bind utilities
...
// Bind services
container.bind(nutrienttype_service_1.NutrientTypeService).toSelf();
...
container.bind(principal_service_1.PrincipalService).toSelf();
// Bind controllers
container.bind(nutrienttype_controller_1.NutrientTypeController).toSelf();
...
container.bind(paystack_controller_1.PaystackController).toSelf();
container.bind(quizcode_controller_1.QuizCodeController).toSelf();
container.bind(principal_controller_1.PrincipalController).toSelf();
