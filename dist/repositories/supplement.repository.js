...
let SupplementRepository = class SupplementRepository {
    ...
    findAll(skip, take) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const supplements = yield this.prisma.$queryRaw `
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const _a = data, { user } = _a, supplementData = __rest(_a, ["user"]);
    ...
    update(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const _a = data, { id: dataId, user } = _a, updateData = __rest(_a, ["id", "user"]);
    ...
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.prisma.supplement.delete({
                where: { id }
            });
        });
    }
    ...
    isInCart(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const cartItems = yield this.prisma.cartItem.findMany({
