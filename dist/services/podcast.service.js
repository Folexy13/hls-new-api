...
let PodcastService = class PodcastService {
    ...
    findAll() {
        return __awaiter(this, arguments, void 0, function* (page = 1, limit = 10) {
            ...
            const result = yield this.podcastRepository.findAll(skip, limit);
    ...
    create(userId, data, file) {
        return __awaiter(this, void 0, void 0, function* () {
            // Upload audio file to S3
            const { url: audioUrl, key } = yield this.s3Service.uploadFile(file);
            try {
                // Create podcast record in database
                return yield this.podcastRepository.create(Object.assign(Object.assign({}, data), { userId,
                    audioUrl }));
            }
            catch (error) {
                // If database creation fails, delete the uploaded file
                yield this.s3Service.deleteFile(key);
                throw error;
            }
        });
    }
    update(id, userId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const podcast = yield this.findById(id);
            if (!podcast) {
    ...
    delete(id, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (key) {
                // Delete file from S3
                yield this.s3Service.deleteFile(`podcasts/${key}`);
            }
            // Delete podcast record from database
            yield this.podcastRepository.delete(id);
        });
    }
    getStreamUrl(id) {
        return __awaiter(this, void 0, void 0, function* () {
