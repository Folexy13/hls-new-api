    ...
    addToCart(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const cart = yield this.cartService.addToCart(userId, data);
                return response_utility_1.ResponseUtil.success(res, { cart });
            }
            catch (error) {
                return response_utility_1.ResponseUtil.error(res, error);
    ...
    updateCartItem(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const cart = yield this.cartService.updateCartItem(userId, itemId, data);
                if (!cart) {
    ...
    removeCartItem(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const userId = req.user.id;
                const itemId = parseInt(req.params.id);
                const cart = yield this.cartService.removeCartItem(userId, itemId);
                if (!cart) {
                    return response_utility_1.ResponseUtil.error(res, 'Cart item not found', 404);
                }
                return response_utility_1.ResponseUtil.success(res, { cart });
