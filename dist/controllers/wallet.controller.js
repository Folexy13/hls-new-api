...
let WalletController = class WalletController extends base_controller_1.BaseController {
    ...
    getWallet(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const wallet = yield this.walletService.getWallet(userId);
                if (!wallet) {
    ...
    requestWithdrawal(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const withdrawal = yield this.walletService.requestWithdrawal(userId, userRole, wallet.id, withdrawalData);
    ...
    getWithdrawals(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const userId = req.user.id;
                const withdrawals = yield this.walletService.getWithdrawals(userId);
    ...
    getWithdrawalById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const withdrawal = yield this.walletService.getWithdrawalById(withdrawalId);
                if (!withdrawal) {
